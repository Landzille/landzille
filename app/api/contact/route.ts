          ...
          <html>
            <head>
              <style>
                ...
                .header { background: #2F6A50; color: white; padding: 30px 20px; border-radius: 5px 5px 0 0; text-align: center; }
                ...
                .label { font-weight: bold; color: #1a4d2e; display: block; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; }
                .value { color: #333; font-size: 16px; }
                .message-box { background: #f9f9f9; padding: 15px; border-radius: 5px; border-left: 4px solid #4caf50; }
                .footer { text-align: center; margin-top: 20px; padding: 20px; color: #666; font-size: 12px; background: #f5f5f5; border-radius: 0 0 5px 5px; }
                .footer p { margin: 5px 0; }
                .reply-button { display: inline-block; margin-top: 20px; padding: 12px 30px; background: #4caf50; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; }
              </style>
            </head>
            <body>
              <div class="container">
                ...
                <div class="content">
                  ...
                  <div class="field">
                    ...
                    <div class="message-box"><p class="value">${message.replace(
                      /\n/g,
                      "<br>"
                    )}</p></div>
                  </div>
                ...
                <div class="footer">
                  ...
                  <p style="margin-top: 15px; color: #999;">This contact has been automatically added to your Mailchimp audience with the "Contact Form" tag.</p>
                </div>
              </div>
            </body>
          </html>
