  ...
  try {
    ...
    if (!response.ok) {
      ...
      if (data.title === "Member Exists") {
        ...
        const updateUrl = `https://${serverPrefix}.api.mailchimp.com/3.0/lists/${audienceId}/members/${subscriberHash}`;
        ...
        await fetch(tagsUrl, {
          ...
          body: JSON.stringify({
            tags: [
              ...
              { name: "Land Investment", status: "active" },
            ],
          }),
        });
